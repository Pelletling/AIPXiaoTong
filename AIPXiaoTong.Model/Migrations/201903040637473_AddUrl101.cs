namespace AIPXiaoTong.Model.Migrations
{
    ...
    public partial class AddUrl101 : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "dbo.PingAnOrderPaidUnFreeze",
                c => new
                    {
        ...
        {
            DropForeignKey("dbo.PingAnOrderPaidUnFreeze", "OrderPaidID", "dbo.OrderPaid");
            DropIndex("dbo.PingAnOrderPaidUnFreeze", new[] { "OrderPaidID" });
            DropTable("dbo.PingAnOrderPaidUnFreeze");
        }
    }
}
