...
{
    public class QueryOrderBookingDetailResponse : BaseResponse
    {
        ...
        private string _ordertime { get; set; }
        ...
        private string _ordermobile { get; set; }
        ...
        public string ordertime { get { return !string.IsNullOrWhiteSpace(_ordertime) ? _ordertime : ""; } set { _ordertime = value; } }
        ...
        public string ordername { get { return !string.IsNullOrWhiteSpace(_ordername) ? _ordername : ""; } set { _ordername = value; } }
        public string ordermobile { get { return !string.IsNullOrWhiteSpace(_ordermobile) ? _ordermobile : ""; } set { _ordermobile = value; } }
    }
}
