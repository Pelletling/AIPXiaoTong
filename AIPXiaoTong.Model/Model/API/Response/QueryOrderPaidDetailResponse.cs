...
namespace AIPXiaoTong.Model.API
{
    public class QueryOrderPaidDetailResponse : BaseResponse
    {
        ...
        private string _unfreezedate { get; set; }
        ...
        public string unfreezedate { get { return !string.IsNullOrWhiteSpace(_unfreezedate) ? _unfreezedate : ""; } set { _unfreezedate = value; } }
