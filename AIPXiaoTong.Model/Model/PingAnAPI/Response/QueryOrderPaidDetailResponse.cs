...
{
    public class QueryOrderPaidDetailResponse : BaseResponse
    {
        ...
        private string _freezesuccesstime { get; set; }

        private string _generalinfo { get; set; }
        private string _unfrozentime { get; set; }
        ...
        public string freezesuccesstime { get { return !string.IsNullOrWhiteSpace(_freezesuccesstime) ? _freezesuccesstime : ""; } set { _freezesuccesstime = value; } }
        public string generalinfo { get { return !string.IsNullOrWhiteSpace(_generalinfo) ? _generalinfo : ""; } set { _generalinfo = value; } }
        public string unfrozentime { get { return !string.IsNullOrWhiteSpace(_unfrozentime) ? _unfrozentime : ""; } set { _unfrozentime = value; } }
    }
}
