...
namespace AIPXiaoTong.Site.Controllers
{
    ...
    public class TestController : Controller
    {
        ...
        public string BBCQryOrder()
        {
            //var response0 = ipingAnAPIService.PreparedFreezeOrder();
            //var response1 = ipingAnAPIService.QueryMarginsOrderDetail();
            //var response2 = ipingAnAPIService.UnFreezeMarginsOrder();
        ...
        public void tlt()
        {
           // Service.TltService tltService = new Service.TltService();
           // tltService.test();
        }
