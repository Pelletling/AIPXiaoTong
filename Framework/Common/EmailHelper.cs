...
namespace Framework.Common
{
    public class EmailHelper
    {
        ...
        public EmailHelper(string server, string toMail, string fromMail, string subject, string emailBody, string username, string password, string port, bool sslEnable = false, bool pwdCheckEnable = false)
        {

            mMailMessage = new MailMessage();
            mMailMessage.To.Add(toMail.Replace(';',','));
