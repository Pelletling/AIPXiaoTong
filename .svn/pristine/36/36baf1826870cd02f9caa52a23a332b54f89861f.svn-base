namespace AIPXiaoTong.Model
{
    ...
    public class AIPXiaoTongDb : DbContext
    {
        ...
        public DbSet<PingAnOrderPaid> PingAnOrderPaid { get; set; }
        public DbSet<AccountPingAn> AccountPingAn { get; set; }
        public DbSet<PingAnOrderPaidRecharge> PingAnOrderPaidRecharge { get; set; }
        public DbSet<PingAnOrderPaidUnFreeze> PingAnOrderPaidUnFreeze { get; set; }
        public DbSet<MerchantMember> MerchantMember { get; set; }
        public DbSet<TLTPreferences> TLTPreferences { get; set; }
