...
namespace AIPXiaoTong.Admin.Controllers
{
    ...
    public class UpController : Controller
    {
        ...
        private void InitMenu()
        {
            ...
            list.Add(new EmployeeMenu() { Code = "001001004", Name = "收银宝参数配置", Controller = "Preferences", Action = "Index,Create,Query", Url = "/Preferences/Create", Sort = 4 });
            list.Add(new EmployeeMenu() { Code = "001001005", Name = "通联通参数配置", Controller = "TLTPreferences", Action = "Index,Create,Query", Url = "/TLTPreferences/Create", Sort = 5 });
        ...
        private void InitMenuAction()
        {
            ...
            list.Add(new EmployeeMenuAction() { MenuCode = "001001005", Code = ActionCode.Modify.ToString(), Name = ActionCode.Modify.ToDescription(), Sort = 2 });
            list.Add(new EmployeeMenuAction() { MenuCode = "001001005", Code = ActionCode.Delete.ToString(), Name = ActionCode.Delete.ToDescription(), Sort = 3 });
            ...
            list.Add(new EmployeeMenuAction() { MenuCode = "001002001", Code = ActionCode.Withdraw.ToString(), Name = ActionCode.Withdraw.ToDescription(), Sort = 4 });
            //list.Add(new EmployeeMenuAction() { MenuCode = "001002001", Code = ActionCode.Delete.ToString(), Name = ActionCode.Delete.ToDescription(), Sort = 5 });
            ...
            list.Add(new EmployeeMenuAction() { MenuCode = "001003001", Code = ActionCode.Delete.ToString(), Name = ActionCode.Delete.ToDescription(), Sort = 4 });
            // list.Add(new EmployeeMenuAction() { MenuCode = "001003001", Code = ActionCode.Audit.ToString(), Name = ActionCode.Audit.ToDescription(), Sort = 5 });
            // list.Add(new EmployeeMenuAction() { MenuCode = "001003001", Code = ActionCode.NotPass.ToString(), Name = ActionCode.NotPass.ToDescription(), Sort = 6 });
            ...
            list.Add(new EmployeeMenuAction() { MenuCode = "001003002", Code = ActionCode.Audit.ToString(), Name = ActionCode.Audit.ToDescription(), Sort = 4 });
            list.Add(new EmployeeMenuAction() { MenuCode = "001003002", Code = ActionCode.NotPass.ToString(), Name = ActionCode.NotPass.ToDescription(), Sort = 5 });
            list.Add(new EmployeeMenuAction() { MenuCode = "001003002", Code = ActionCode.AuditReset.ToString(), Name = ActionCode.AuditReset.ToDescription(), Sort = 6 });
            list.Add(new EmployeeMenuAction() { MenuCode = "001003002", Code = ActionCode.Delete.ToString(), Name = ActionCode.Delete.ToDescription(), Sort = 7 });
