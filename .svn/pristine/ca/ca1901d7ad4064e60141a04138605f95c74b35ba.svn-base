...
{
    public class EmployeeRoleCM : BaseCreateModel
    {
        public EmployeeRoleCM()
        {
            EmployeeMenuIDList = new List<long?>();
            EmployeeActionIDList = new List<long?>();
        }
        ...
        /// 菜单ID集合
        /// </summary>
        public List<long?> EmployeeMenuIDList { get; set; }

        public List<long?> EmployeeActionIDList { get; set; }
    }
}
