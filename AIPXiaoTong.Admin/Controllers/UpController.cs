...
namespace AIPXiaoTong.Admin.Controllers
{
    ...
    public class UpController : Controller
    {
        ...
        private void InitMenu()
        {
            ...
            list.Add(new Menu() { Code = "001003004", Name = "收银宝参数配置", Controller = "Preferences", Url = "/Preferences/Index", Sort = 4 });
            list.Add(new Menu() { Code = "001003005", Name = "商户设备管理", Controller = "Equipment", Action = "Index,Create,Query", Url = "/Equipment/Index", Sort = 5 });
            list.Add(new Menu() { Code = "001003006", Name = "通联通参数配置", Controller = "TLTPreferences", Url = "/TLTPreferences/Index", Sort = 6 });
            ...
            list.Add(new Menu() { Code = "001005", Name = "代付信息", Sort = 4 });
            list.Add(new Menu() { Code = "001005001", Name = "代付订单", Controller = "OntimePay", Url = "/OntimePay/Index", Sort = 1 });
        ...
        private void InitMenuAction()
        {
            ...
            list.Add(new MenuAction() { MenuCode = "001003003", Code = ActionCode.AddDetail.ToString(), Name = ActionCode.AddDetail.ToDescription(), Sort = 4 });
            ...
            list.Add(new MenuAction() { MenuCode = "001003006", Code = ActionCode.Index.ToString(), Name = ActionCode.Index.ToDescription(), Sort = 1 });
            list.Add(new MenuAction() { MenuCode = "001003006", Code = ActionCode.Modify.ToString(), Name = ActionCode.Modify.ToDescription(), Sort = 2 });
            list.Add(new MenuAction() { MenuCode = "001003006", Code = ActionCode.Add.ToString(), Name = ActionCode.Add.ToDescription(), Sort = 3 });
            list.Add(new MenuAction() { MenuCode = "001003006", Code = ActionCode.Delete.ToString(), Name = ActionCode.Delete.ToDescription(), Sort = 4 });
            ...
            list.Add(new MenuAction() { MenuCode = "001004001", Code = ActionCode.Add.ToString(), Name = ActionCode.Add.ToDescription(), Sort = 5 });
            list.Add(new MenuAction() { MenuCode = "001004001", Code = ActionCode.AuditReset.ToString(), Name = ActionCode.AuditReset.ToDescription(), Sort = 6 });
            ...
            list.Add(new MenuAction() { MenuCode = "001005001", Code = ActionCode.Index.ToString(), Name = ActionCode.Index.ToDescription(), Sort = 1 });
            list.Add(new MenuAction() { MenuCode = "001005001", Code = ActionCode.Details.ToString(), Name = ActionCode.Details.ToDescription(), Sort = 2 });
