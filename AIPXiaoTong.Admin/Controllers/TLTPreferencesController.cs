...
namespace AIPXiaoTong.Admin.Controllers
{
    public class TLTPreferencesController : BaseController
    {
        ...
        public string SiteTltUrl = GlobalConfig.WebConfig.SiteTltUrl;
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(m.TLTSecurityCer))
                    {
                        ...
                        System.IO.File.Copy(Server.MapPath(m.TLTSecurityCer), SiteTltUrl+ tarSecurityCerSource);
                    ...
                    if (!string.IsNullOrWhiteSpace(m.TLTPrivateKeyCer))
                    {
                        ...
                        System.IO.File.Copy(Server.MapPath(m.TLTPrivateKeyCer), SiteTltUrl+ tarPrivateKeyCerSource);
